...
Vue.use(Quasar, { config: {"loading":{"delay":400},"capacitor":{"backButtonExit":false,"backButton":false},"cordova":{"backButtonExit":false,"backButton":true},"brand":{"primary":"#70B937","secondary":"#26A69A","accent":"#9C27B0","dark":"#1d1d1d","positive":"#67C23A","negative":"orange","info":"#909399","warning":"#E6A23C"}},components: {QLayout,QHeader,QDrawer,QPageContainer,QPage,QToolbar,QToolbarTitle,QBtn,QIcon,QInput,QList,QItem,QField,QItemSection,QUploader,QChip,QSelect,QRating,QToggle,QDate,QTime,QCard,QCardSection,QSeparator},directives: {Ripple},plugins: {Notify,Dialog,Loading,AppFullscreen} })
