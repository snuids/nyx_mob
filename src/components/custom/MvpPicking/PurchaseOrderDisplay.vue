  ...
  methods: {
    async getPurchaseOrder() {
      ...
      this.$store.commit('mvpPicking/mutate_currentOrder', {
        order: {
          meta: {
            id: this.$store.state.mvpPicking.currentOrder.meta.id,
            index: this.$store.state.mvpPicking.currentOrder.meta.index
          },
          details: {
    ...
    requestOrder() {
      var url =
        ...
        'generic/' +
        this.$store.state.mvpPicking.currentOrder.meta.index +
        '/' +
        this.$store.state.mvpPicking.currentOrder.meta.id +
        '?token=' +
    ...
    sendOrderToServer() {
      ...
      var updatedPurchaseOrder = {
        _index: this.$store.state.mvpPicking.currentOrder.meta.index,
